...
`;
  ...
  `;
	...
	*/
	...
	const skillKeys = [['special_skill', 'special'], ['action_ability1', 'skill-1'], ['action_ability2', 'skill-2'], ['action_ability3', 'skill-3'], ['action_ability4', 'skill-4'], ['support_ability1', 'support-1'], ['support_ability2', 'support-2'], ['support_ability3', 'support-3'], ['support_ability_of_npczenith', 'skill-lb'], ['support_ability_of_npczenith', 'skill-lb2'], ['appear_ability', 'skill-main'], ['backmember_ability1', 'skill-sub']];
	const state = {
	  status: 'init',
	  cStatus: 'init',
	  locSkMap: false,
