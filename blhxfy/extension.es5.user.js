...
(function () {
  ...
  */
  ...
  var skillKeys = [['special_skill', 'special'], ['action_ability1', 'skill-1'], ['action_ability2', 'skill-2'], ['action_ability3', 'skill-3'], ['action_ability4', 'skill-4'], ['support_ability1', 'support-1'], ['support_ability2', 'support-2'], ['support_ability3', 'support-3'], ['support_ability_of_npczenith', 'skill-lb'], ['support_ability_of_npczenith', 'skill-lb2'], ['appear_ability', 'skill-main'], ['backmember_ability1', 'skill-sub']];
  var state = {
    status: 'init',
    cStatus: 'init',
    locSkMap: false,
  ...
  var parseSkill = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, pathname) {
      var npcId, level, skillState, skillData, translated, keys, lbCount, _iterator3, _step3, item, key1, key2, ability, lbLoopCount, abTemp, _k, _getPlusStr, _getPlusStr2, plus1, plus2, _trans4, list, trans, intro, _trans2, _intro, _trans3;
